package ch.hearc.bilat_example.jvmsecret.use;

import java.net.MalformedURLException;
import java.rmi.RemoteException;

import ch.hearc.bilat_example.SettingsRMI;
import ch.hearc.bilat_example.jvmhorloge.moo.HorlogeRemote_I;
import ch.hearc.bilat_example.gui.JHorloge;
...
public class PCSecret
{
    ...
    private void workHorloge()
    {
        try
        {
            ...
            new JFrameChat(new JHorloge(horlogeRemote));
        }
