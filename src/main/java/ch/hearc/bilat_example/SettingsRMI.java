package ch.hearc.bilat_example;

import java.net.InetAddress;

import ch.hearc.bilat_example.jvmhorloge.moo.Horloge;
import ch.hearc.bilat_example.jvmsecret.moo.Secret;
...
public class SettingsRMI
{
    ...
    private static final String SECRET_RMI_ID = Secret.class.getName();// Why not! garantit unicity
    private static final int SECRET_RMI_PORT = Ports.PORT_RMI_DEFAUT;
    private static final InetAddress SECRET_INETADDRESS = secretIP();

    public static final RmiURL SECRET_RMI_URL = new RmiURL(SECRET_RMI_ID, SECRET_INETADDRESS, SECRET_RMI_PORT);

	/*------------------------------*\
	|*				Horloge 		*|
	\*------------------------------*/

    private static final String HORLOGE_RMI_ID = Horloge.class.getName();// Why not! garantit unicity
    private static final int HORLOGE_RMI_PORT = Ports.PORT_RMI_DEFAUT;
    private static final InetAddress HORLOGE_INETADDRESS = horlogeIP();

    public static final RmiURL HORLOGE_RMI_URL = new RmiURL(HORLOGE_RMI_ID, HORLOGE_INETADDRESS, HORLOGE_RMI_PORT);
